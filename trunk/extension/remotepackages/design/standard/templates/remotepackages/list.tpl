<form name="packages" action={concat("/remotepackages/list/",$selected_repository|urlencode)|ezurl} method="post">
...
<div class="right">
        <p>
        {switch match=ezpreference( 'remotepackages_list_viewmode' )}
        {case match='thumbnail'}
        <a href={'/user/preferences/set/remotepackages_list_viewmode/list'|ezurl} title="{'Display packages using a simple list.'|i18n( 'design/admin/node/view/full' )}">{'List'|i18n( 'design/admin/node/view/full' )}</a>
        <span class="current">{'Thumbnail'|i18n( 'design/admin/node/view/full' )}</span>
        {*<a href={'/user/preferences/set/remotepackages_list_viewmode/detailed'|ezurl} title="{'Display packages using a detailed list.'|i18n( 'design/admin/node/view/full' )}">{'Detailed'|i18n( 'design/admin/node/view/full' )}</a>*}
        {/case}

        {*
        {case match='detailed'}
        <a href={'/user/preferences/set/remotepackages_list_viewmode/list'|ezurl} title="{'Display packages using a simple list.'|i18n( 'design/admin/node/view/full' )}">{'List'|i18n( 'design/admin/node/view/full' )}</a>
        <a href={'/user/preferences/set/remotepackages_list_viewmode/thumbnail'|ezurl} title="{'Display packages as thumbnails.'|i18n( 'design/admin/node/view/full' )}">{'Thumbnail'|i18n( 'design/admin/node/view/full' )}</a>
